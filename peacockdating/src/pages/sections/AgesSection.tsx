    ...
    <section id="ages" className="py-12 md:py-20 bg-surface">
      <div className="container">
        ...
        <div className="flex flex-col md:flex-row gap-8 max-w-4xl mx-auto">
          <Card className="glass-card border-l-4 border-peacock-green flex-1 flex flex-col justify-between">
            <div>
          ...
          <Card className="glass-card border-l-4 border-peacock-purple flex-1 flex flex-col justify-between">
            <div>
              <div className="flex items-center gap-3 mb-4">
                <svg
